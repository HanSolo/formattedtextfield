...
public class Format {
    ...
    public Format(final String pattern, final String unit, final String units, final String prompt) {
        this(StandardType.NONE, pattern, unit, units, prompt, Locale.getDefault());
    }
